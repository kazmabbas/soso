...
{
{text = 'سورس ساندي - 𝗦𝗼𝘂𝗿𝗰𝗲 𝗦𝗮𝗻𝙙𝙮',type = 'text'},
},
}
}
...
if text == "سورس ساندي - 𝗦𝗼𝘂𝗿𝗰𝗲 𝗦𝗮𝗻𝙙𝙮" then 
send(msg.chat_id,msg.id,"˛ مرحبا بكم في سورس ساندي \nالقناة مخصصة للبيع الملفات وا بوتات\n\nالمطور: @qqzqqx\nمصدر ساندي: @BxxBxxL\nليس لدينا أي حسابات أخرى غير هذه","md",true)  
if text == "source" then 
